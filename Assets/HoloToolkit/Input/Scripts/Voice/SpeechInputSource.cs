...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public partial class SpeechInputSource : BaseInputSource
    {
        ...
        public override bool TryGetSourceKind(uint sourceId, out UnityEngine.XR.WSA.Input.InteractionSourceKind sourceKind)
        {
            sourceKind = UnityEngine.XR.WSA.Input.InteractionSourceKind.Voice;
            return true;
        }
